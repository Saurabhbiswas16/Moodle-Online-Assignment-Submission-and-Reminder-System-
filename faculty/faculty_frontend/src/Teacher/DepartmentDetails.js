...
import {makeStyles,FormControl,InputLabel ,MenuItem ,FormHelperText ,Select } from '@material-ui/core';
...
function DepartmentDetails(props) {
    ...
    return (
        ...
        <div className="DepartmentHeader">
            ...
            {currentbatch.length!==0 && currentsubject.length!==0 ? (<Button variant="contained" onClick={tempdata}>Show</Button>):null}
            </div>
        </div>
