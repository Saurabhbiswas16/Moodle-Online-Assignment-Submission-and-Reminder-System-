...
function CreateNewSubject() {
    ...
    const departmentSubmit = async(event)=> {
        ...
        const temp = { sub: subjectDetails};
        const req = await axios.post("/departmentDetails/createsubject", temp);
        setdataSent(true);
    }
        ...
        >
            ...
            <div className="form-group">
              <TextField
                ...
                type="text"
                name="subjectName"
                value={setsubjectDetails.subjectName}
                onChange={createSubject}
                required
              />{" "}
            </div>
